...
# SPECIFICATION: program reads file optdigits.tra and simulates grid search using perceptron and MLP
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            output += " accuracy so far: " + "{:.3f}".format(accuracy) + ", Parameters: learning rate=" + str(
                w) + ", shuffle=" + str(b)
            if a == 0 and accuracy >= bestPerceptronAccuracy:
                bestPerceptronAccuracy = accuracy
                print(output)
            elif a == 1 and accuracy >= bestMLPAccuracy:
